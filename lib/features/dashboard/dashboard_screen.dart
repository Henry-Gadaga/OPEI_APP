...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  Widget build(BuildContext context) {
    final screens = [
      DashboardHomeScreen(
        onProfileTap: () => _goTo(4),
        onCardsTap: () => _goTo(1),
        onActivityTap: () => _goTo(3),
      ),
      const CardsScreen(),
      _PayScreen(
...
// ============================================================
// PAY SCREEN (tab 2 — quick access to send/add/withdraw)
// ============================================================

class _PayScreen extends StatelessWidget {
  final VoidCallback onAdd;
  final VoidCallback onSend;
  final VoidCallback onWithdraw;
      ...
      child: Scaffold(
        ...
        body: CustomScrollView(
          ...
          slivers: [
            ...
            SliverToBoxAdapter(
              child: Padding(
                padding: EdgeInsets.fromLTRB(20, topPad + 18, 20, 8),
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    const Text(
            ...
            // ── Search-style entry to start a payment ────────
            SliverToBoxAdapter(
              child: Padding(
                ...
                child: Material(
                  ...
                  child: InkWell(
                    ...
                    borderRadius: BorderRadius.circular(14),
                    splashColor:
                        OpeiBrand.primary.withValues(alpha: 0.06),
                    child: Container(
                      height: 50,
                      ...
                      child: const Row(
                        children: [
                          Icon(Icons.search_rounded,
                              size: 20, color: OpeiBrand.inkTertiary),
                          SizedBox(width: 10),
                          Expanded(
                            child: Text(
                              'Send to name, email or @opei tag',
                              style: TextStyle(
                                fontFamily: kPrimaryFontFamily,
                                fontSize: 14,
                                fontWeight: FontWeight.w500,
            ...
            // ── Hero send card (primary CTA) ─────────────────
            SliverToBoxAdapter(
              child: Padding(
                padding: const EdgeInsets.fromLTRB(20, 0, 20, 22),
                child: _PayHeroCard(onTap: onSend),
              ),
            ),
                  ...
                  child: Column(
                    children: [
                      ...
                      _PayRow(
                        ...
                        title: 'Add money',
                        subtitle: 'Top up via bank or crypto',
                        onTap: onAdd,
                      ),
                      const _PayDivider(),
                      _PayRow(
            ...
            SliverToBoxAdapter(
              child: Padding(
                padding: EdgeInsets.fromLTRB(20, 0, 20, 28 + bottomPad),
                child: _PayInfoBanner(),
              ),
            ),
          ],
        ),
...
// ─────────────────────────────────────────────────────────────
// HERO CTA CARD — gradient "Send money" panel
// ─────────────────────────────────────────────────────────────

class _PayHeroCard extends StatelessWidget {
  final VoidCallback onTap;
  const _PayHeroCard({required this.onTap});
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: const Color(0xFF2257E0).withValues(alpha: 0.22),
                blurRadius: 22,
...
// ─────────────────────────────────────────────────────────────
// QUICK ACTION (icon-only chip used in 4-up row)
// ─────────────────────────────────────────────────────────────

class _PayQuickAction extends StatelessWidget {
  final IconData icon;
  final String label;
  final Color color;
  final Color bg;
...
// ─────────────────────────────────────────────────────────────
// LIST ROW (used inside the grouped white card)
// ─────────────────────────────────────────────────────────────
...
class _PayTag extends StatelessWidget {
  final String label;
  final Color color;
  final Color bg;
...
class _PayInfoBanner extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        children: [
          ...
          const Expanded(
            child: Text(
              'Every transfer is encrypted and protected by Opei security.',
              style: TextStyle(
                fontFamily: kPrimaryFontFamily,
                fontSize: 12,
                fontWeight: FontWeight.w500,
...
class _BottomNav extends StatelessWidget {
  ...
  static const _items = [
    ...
    _NavDef(Icons.swap_horiz_outlined, Icons.swap_horiz_rounded, 'Pay'),
