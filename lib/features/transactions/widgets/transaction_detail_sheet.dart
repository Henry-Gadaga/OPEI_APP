...
class TransactionDetailSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final entries = <_DetailEntry>[
      ...
      _DetailEntry('Type', transaction.humanizedTransactionType),
      _DetailEntry('Direction', directionLabel),
      ...
      _DetailEntry('Date', transaction.formattedDate),
      if ((transaction.description ?? '').trim().isNotEmpty)
        _DetailEntry('Description', transaction.description!.trim(),
            multiline: true),
    ];
